...
class oerclassification extends base {
    ...
    public static function get_enabled_plugins() {
        ...
        foreach ($installed as $plugin => $fulldir) {
            if (isset($enabledplugins[$plugin])) {
                $enabled[$plugin] = get_string('pluginname', 'oerclassification_' . $plugin);
            }
        }
    ...
    public static function get_all_plugins() {
        return core_component::get_plugin_list('oerclassification');
    }
    ...
    public function get_settings_section_name() {
        return 'oerclassification' . $this->name . 'settings';
    }
